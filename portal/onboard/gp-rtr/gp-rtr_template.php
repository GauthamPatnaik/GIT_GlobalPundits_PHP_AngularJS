...
$gpRepresent= $post_data['data']['gpRepresent'];
$gpPosition= $post_data['data']['gpPosition'];
$gpPayRate= $post_data['data']['gpPayRate'];
$gpOTrate= $post_data['data']['gpOTrate'];
$gpPto= $post_data['data']['gpPto'];
$gpPrediem= $post_data['data']['gpPrediem'];

$document_name = ['GP RTR.docx'];
...
for ($j=0;$j<17;$j++) {
  $ans = array (
              ...
              'tabLabel' => 'Ans'.($j+1),
              'sharef' => 'fasle',
              'name' => 'Enter the answer or enter Yes/No wherever applicable',
              'documentId' => '5',
              'recipientId' => '1',
              'pageNumber' => '1',
              'bold' => 'false',
...
$textTab1 = array (
 ...
 $textTab3 = array (
  ...
  'font' => 'TimesNewRoman',
  'fontSize' => 'Size10',
  'anchorString' => 'represent me to _',
  'anchorXOffset' => '100',
  'anchorYOffset' => '-5',
); 
 $textTab4 = array (
...
array_push($answerFields, $textTab8);
array_push($answerFields, $textTab9);
