...
// echo "Get Auth Code";
// echo "<br><br>";
// $authCode=getAuthCode($prod=true);
// echo $authCode."<br><br>";
...
// echo $ping."<br><br>";
//   if ($ping > 600) {
//     echo "Use Same Session";
//    }

// echo "doBullhornAuth<br><br>";
// $doBullhornAuth=json_decode(doBullhornAuth($authCode, $prod=true),true);
// echo "Complete doBullhornAuth Result  <br><br>";
// var_dump($doBullhornAuth)."<br><br>";
// echo "access_token <br><br>";
// echo $doBullhornAuth['access_token'];
// echo "<br><br>";

// echo "doBullhornLogin<br><br>";
// $login = doBullhornLogin($doBullhornAuth['access_token'], true);
// var_dump($login); 
// echo "<br><br>";
...
function getAuthCode($prod=true)
{
  ...
  $content = curl_getinfo($curl, CURLINFO_EFFECTIVE_URL);
...
//Old Code Commented on 16-Feb-2024 By Gautham
//=============================================================================  
//   $curl = curl_init( $url ); 
//   curl_setopt($curl, CURLOPT_URL, $url);
//   curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
