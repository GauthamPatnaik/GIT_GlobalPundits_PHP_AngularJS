...
$url = 'https://'.PROD_AUTH.'.bullhornstaffing.com/oauth/token?grant_type=authorization_code&code='.$authCode.'&client_id='.CLIENT_ID.'&client_secret='.CLIENT_SECRET;
 ...
 echo "From Method 1 <br>". $authCode."<br>";
    curl_close($ch);
...
function bullhornRefreshToken($refCode)
{
...
function doBullhornLogin($accessToken)
{
  ...
  echo "auth 120";
  echo $content;
  echo "<br> Test doBullhornLogin"; echo "<br>";
  return $content;
