...
<div id="section-1" class="container-fluid">
    <div data-sal="slide-up" data-sal-duration="500" class="container">
         <div id="first-section" class="row align-items-center justify-content-center">
            <div data-rellax-speed="3" id="illus-container" class="col-lg-8 rellax"
                data-friction-x="0.1"
                data-friction-y="0.1"
                data-scalar-x="10"
                data-scalar-y="10">

       <h3 style="color:black; font-size: 17px; border-style: none;">Engineering and technical support for DOE-, DOD-, and NNSA-aligned programs across nuclear(including SMRs), defense and national security–critical industries.
</h3>

            </div>
            <div data-rellax-speed="5" id="info-container" class="col-lg-4 rellax">
                <div id="landing-info">
                    <!--<h1>Who are we?</h1>-->
...
<div id="section-4" class="container-fluid">
    <div id="clients-container" class="container">
            ...
            <div class="row">
                <div data-sal="slide-up" data-sal-duration="500" data-sal-delay="100" class="col-lg-6 services-block">
                    <!--<img class="services-images" src="images/public.png" alt="Higher Education">-->
                     <h1 class="text-center acc-color " style="text-align:left">Programs & Industries</h1>
                    <p style="text-align:left">Providing management, engineering, and technical services to DOE-, NNSA-, NRC-, and DOD-aligned programs across nuclear operations, Small Modular Reactors (SMRs), AI-enabled nuclear energy integration, national security, environmental remediation, infrastructure modernization, and regulated energy systems. Our work supports mission-critical programs operating in safety-, compliance-, and oversight-driven environments.
</p>
                </div>
                 <div data-sal="slide-up" data-sal-duration="500" data-sal-delay="100" class="col-lg-6 services-block">
                    <!--<img class="services-images" src="images/public.png" alt="Higher Education">-->
                     <h1 class="text-center acc-color " style="text-align:left">Delivery & Controls</h1>
                    <p style="text-align:left">Delivering task-order-based support across a broad range of technical and professional disciplines, including project controls, schedule and cost management, and Earned Value Management System (EVMS) support aligned with ANSI/EIA-748 principles. Proven ability to rapidly mobilize qualified personnel and resources enables disciplined execution, reporting rigor, and consistent performance across complex, compliance-driven assignments.
