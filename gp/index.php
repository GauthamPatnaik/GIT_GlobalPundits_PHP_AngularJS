...
<div id="section-1" class="container-fluid">
    <div data-sal="slide-up" data-sal-duration="500" class="container">
         <div id="first-section" class="row align-items-center justify-content-center">
            <div data-rellax-speed="3" id="illus-container" class="col-lg-12 rellax"
                data-friction-x="0.1"
                data-friction-y="0.1"
                data-scalar-x="10"
                data-scalar-y="10">
...
<div id="section-4" class="container-fluid">
    ...
    <div 
        ...
        data-sal-delay="100"
        class="col-lg-6 services-block programs-col">

        <h1 class="services-heading acc-color">
            Programs & Industries
        </h1>
    ...
    <div 
        ...
        data-sal-duration="500"
        data-sal-delay="100"
        class="col-lg-6 services-block delivery-col">
