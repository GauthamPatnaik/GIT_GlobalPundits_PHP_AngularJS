...
<div id="section-3" class="container-fluid">
    <div id="services-container" class="container">
        ...
        <div data-sal="slide-up" data-sal-duration="500" class="row justify-content-center align-items-center">
            <div class="col-lg-3 section-3-img-block">
                <img src="images/staff.png" alt="Defense IT & Cybersecurity">
            </div>
            <div class="col-lg-8">
        ...
        <div data-sal="slide-up" data-sal-duration="500" class="row justify-content-center align-items-center">
			<div class="col-lg-3 section-3-img-block mobile-block">
                <img src="images/ems.png" alt="Nuclear & Energy Engineering">
            </div>
            <div class="col-lg-8">
        ...
        <div class="row justify-content-around align-items-bottom">
            ...
            <div data-sal="slide-up" data-sal-duration="500" data-sal-delay="100" class="col-lg-3">
                <h3> Innovation with Purpose</h3>
                    <p>We don't just provide staff; we provide progress. Whether it is implementing AI-driven solutions or supporting the next generation of Small Modular
            ...
            <div data-sal="slide-up" data-sal-duration="500" data-sal-delay="100" class="col-lg-3">
                 ...
                 <p>We bridge the gap between North American technical rigor and the visionary growth of the Middle East. Our value lies in our ability to deliver worldclass ERP and IT expertise while respecting and supporting the local goals of the regions where we operate.</p>
            </div>
            <div data-sal="slide-up" data-sal-duration="500" data-sal-delay="100" class="col-lg-3">
