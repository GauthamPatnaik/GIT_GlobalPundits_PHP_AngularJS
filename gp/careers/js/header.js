$(document).ready(function() {
    ...
    $(document).scroll(function() {
        ...
        if (scroll>50) {
            ...
            TweenMax.to("#header-link-bg", 0.3, {width:"550px", height:"40px", top:10, right:10, borderRadius:5, position:"absolute", backgroundColor:"#00467F", boxShadow:"0px", ease: Power1.easeInOut});
